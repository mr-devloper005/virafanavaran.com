export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'virafanavaran',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Virafanavaran',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'virafanavaran.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://virafanavaran.com',
